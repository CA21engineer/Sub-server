...
require (
	github.com/BambooTuna/go-server-lib v0.0.0-20200609081122-0ca1949a2400
	github.com/CA21engineer/Subs-server v0.0.0-20200609032931-293a1903bb5e
	github.com/CA21engineer/Subs-server/apiServer v0.0.0-20200610021506-711f4f0b6081 // indirect
